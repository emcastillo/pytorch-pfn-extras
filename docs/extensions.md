...
It is possible to take snapshots by using the [`snapshot`](https://github.com/pfnet/pytorch-pfn-extras/blob/1aa0fa47ad972d1514b034fdb05afcb3e7eef538/example/mnist.py#L133)
...
To load the snapshot and continue the training call `torch.load` and use the `ExtensionsManager.load_state_dict`[example](https://github.com/pfnet/pytorch-pfn-extras/blob/a5d1d356b7a53e793423f334137f8134edca089b/example/mnist.py#L139-L141) to resume the training.
