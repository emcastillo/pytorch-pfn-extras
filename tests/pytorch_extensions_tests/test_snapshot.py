...
# TestSnapshot(unittest.TestCase):
...
# TestSnapshotSaveFile(unittest.TestCase):
...
# TestSnapshotOnError(unittest.TestCase):
...
# TestFindSnapshot(unittest.TestCase):
def setUp(self):
...
# TestFindSnapshot2(unittest.TestCase):
def setUp(self):
    self.path = tempfile.mkdtemp()
...
# TestFindStaleSnapshot(unittest.TestCase):
def setUp(self):
    self.path = tempfile.mkdtemp()
...
# TestRemoveStaleSnapshots(unittest.TestCase):
def setUp(self):
    self.path = tempfile.mkdtemp()
