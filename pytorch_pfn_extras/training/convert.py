...
class Converter:
    ...
    .. seealso::
        :meth:`pytorch_pfn_extras.convert.converter` --- a decorator
...
def converter():
    ...
    :class:`pytorch_pfn_extras.convert.Converter` class instance,
    ...
    .. admonition:: Example
        ...
        >>> @pytorch_pfn_extras.training.convert.converter()
...
def to_device(device, x):
    ...
    :class:`~pytorch_pfn_extras.training.Extension`
    such as :class:`~pytorch_pfn_extras.training.extensions.Evaluator`.
